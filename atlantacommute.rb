...
puts "You have been driving for " + age_in_years.to_s + " in years,but " + age_in_days.to_s + " in days, and " + age_in_seconds.to_s + " in seconds."
if age_in_years < 24 
...
puts "Luckily, it is now only 5 minuts into your commute, so you are still in a good mood."
...
if user_input == 'drive faster'
	...
	puts "You swerve into the next left lane. The guy behin you flips you off. You smile in your rearview mirror."
else
end	

puts "You see blue lights blinking behind you."
puts "What do you do?"
puts "Please answer 'ignore it' or 'pull over'."
user_input = gets.chomp
if user_input == 'ignore it'
	puts "You are losing " + time.to_s + " minutes the longer you delay this."
elsif user_input == 'pull over'
	puts "Good call. You have saved " + time.to_s + "minutes."
else 
...
puts "..."
puts "SIRI: " + name + " ,you have lost " + time.to_s + " minutes."
user_input = gets
...
puts "You wait " + time.to_s + " minutes for your " + coffee + "."
